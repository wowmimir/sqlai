import uuid
from sqlalchemy import Column, String, BigInteger, DateTime, func, Text, ForeignKey, Index
...
class Project(Base):
    ...
    semantic_prompts = relationship("SemanticPromptCache", back_populates="project", cascade="all, delete-orphan")
...
class SemanticPromptCache(Base):
    ...
    __table_args__ = (
        Index('idx_prompt_embedding_hnsw', 'prompt_embedding', postgresql_using='hnsw', postgresql_ops={'prompt_embedding': 'vector_cosine_ops'}),
    )
